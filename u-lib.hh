...
//      map the console at a user specified address 'addr'. This adddress must
//      be low canonical and page aligned. Return 0 on success, -1 on failure,
//      and E_INVAL on invalid 'addr'.
